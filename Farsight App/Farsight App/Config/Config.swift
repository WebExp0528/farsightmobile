...
struct Config {
    ...
    var jobDetailURL:String {
        get {
            if let value = mergeWithParent(self.jobDetail) {
                return value
            }
            return ""
        }
    }
    var getPhotosURL:String {
        get {
            if let value = mergeWithParent(self.getPhotos) {
                return value
            }
            return ""
        }
    ...
    private let jobDetail =  "/api/work_order/"
    private let getPhotos = "/api/work_order/"
